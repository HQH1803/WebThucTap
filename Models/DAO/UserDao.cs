   ...
   public class UserDao
    {
        ...
        public int Login(string userNameOrEmail, string passWord, bool isLoginAdmin = false)
        {
            var result = db.Users.SingleOrDefault(x => x.Username == userNameOrEmail || x.Email == userNameOrEmail);
            if (result == null)
            {
                return 0;
            }
